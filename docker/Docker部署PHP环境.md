...
![image-20231009010518254](http://img.an520.com/test/image-20231009010518254.png)

启动PHP后，返回的名称为`php-test`的容器唯一ID。

可以通过 `docker ps` 查看Docker 创建的容器

![image-20231009010534138](http://img.an520.com/test/image-20231009010534138.png)
...
![image-20231009013337137](http://img.an520.com/test/image-20231009013337137.png)
...
![image-20231009011651422](http://img.an520.com/test/image-20231009011651422.png)
...
![image-20231009015325479](http://img.an520.com/test/image-20231009015325479.png)
...
![image-20231009014227880](http://img.an520.com/test/image-20231009014227880.png)
