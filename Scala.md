...
![Scala中的数据类型转换](https://github.com/tch0/notes/raw/master/Images/Scala_implicit_datatype_cast.jpg)
...
scala> a.to
to               toByte   toDegrees   toFloat       toInt    toLower         toRadians   toString      toUpper
toBinaryString   toChar   toDouble    toHexString   toLong   toOctalString   toShort     toTitleCase
...
scala> val octonray = 038
<console>:1: error: Decimal integer literals may not have a leading zero. (Octal syntax is obsolete.)
       val octonray = 038
                      ^

scala> val binary = 0B10101010
...
| 6        | boolean startsWith(String prefix)  测试此字符串是否以指定的前缀开始 |
