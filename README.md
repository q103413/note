<img src="http://img.rmb520.com/test/mywechat.jpg" width="150px">

<img src="http://img.rmb520.com/test/mypublic.jpg" width="150px">
...
边距和填充：
	1 边距（margin、外边距、外补丁）：围绕在元素边框的空白区域
    2 填充(padding、内边距、补白、内补丁)：定义元素边框与元素内容之间的空白区域。
